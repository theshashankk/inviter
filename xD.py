...
from lwda import edit_or_reply
api_id = 1621727
api_hash = '31350903c528876f79527398c09660ce'
token = '1861962418:AAFXpzpvz1LcaCo7EPjMyRdFvzAVT9WtSAQ'
xd = TelegramClient("xd", api_id, api_hash).start(bot_token=token)
...
@xd.on(
    events.NewMessage(pattern="^/inviteall ?(.*)", func=lambda e: e.sender_id in SMEX_USER)
)
